...
@SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        getContentPane().add(panelData, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 90, 360, 360));
        ...
        getContentPane().add(btnNext, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 400, 120, 50));
        ...
        getContentPane().add(lblBackgroud, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 590, 470));
    ...
    private void btnNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextActionPerformed
        ...
        String diseases = txtAlergias.getText();
    ...
    private void insertDataIntoFactsBaseDB(String name, String birth_Date, String age,
        ...
        int queryResult = dbController.sqlInsertFacts(name, birth_Date, age, address, sex, weight, height, diseases);
         ...
         if (queryResult == 1) {
            JOptionPane.showConfirmDialog(null, "- Registro insertado correctamente!", "Mensaje", JOptionPane.OK_OPTION);
             cleanFields();
            showRoutinesScreen();
        } else {
            JOptionPane.showConfirmDialog(null, "- Error Insertando Registro!", "Mensaje", JOptionPane.OK_OPTION);
        }
        
    }
    
    public void showRoutinesScreen(){
        SelectRoutines routines = new SelectRoutines();
